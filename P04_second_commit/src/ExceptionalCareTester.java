...
public class ExceptionalCareTester {
  ...
  public static boolean testAdmissionsConstructorValid() {
    ...
    //I initially use if(!admissions.toString().isBlank()){}, cause I have seen that method is the tester
    //given to us, but I'm not sure whether we can use that method so I switch it to == null
    if(!(admissions.toString() == null)) {
      return false;
    }
    System.out.println("0");
